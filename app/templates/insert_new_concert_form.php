...
<form action="index.php" method="post">
	<fieldset>
		...
		<p>
			<label for="cName">Artist Name</label> <input type="text"
				id="cName" name="cName" placeholder="Artist Name"
				maxlength="50" required />
		</p>
		<p>
			<label for="cVenue">Venue</label> <input type="text"
				id="cVenue" name="cVenue" placeholder="Venue"
				maxlength="50" required />
		</p>
		<p>
